...
class ConsultationControllerTest {
    ...
    public void calling_assignForConsultation_with_valid_test_request_id_should_update_the_request_status(){
        ...
        //Act
        testRequestInput = consultationController.assignForConsultation(testRequest.requestId);

        //Assert
        assertThat(testRequest.getRequestId(),equalTo(testRequestInput.getRequestId()));
        assertThat(testRequestInput.getStatus(),equalTo(RequestStatus.DIAGNOSIS_IN_PROCESS));
        assertNull(testRequest.getConsultation());
