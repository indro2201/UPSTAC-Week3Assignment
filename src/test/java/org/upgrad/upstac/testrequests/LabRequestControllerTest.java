...
class LabRequestControllerTest {
    ...
    public void calling_assignForLabTest_with_valid_test_request_id_should_update_the_request_status(){
       ...
       //Arrange
        ...
        //Act
        testRequestInput = labRequestController.assignForLabTest(testRequest.requestId);

        //Assert
        assertThat(testRequest.getRequestId(),equalTo(testRequestInput.getRequestId()));
        assertThat(testRequestInput.getStatus(),equalTo(RequestStatus.LAB_TEST_IN_PROGRESS));
        assertNull(testRequest.getLabResult());
    }
   ...
   /* private TestRequest createTestRequest(){
        ...
        testRequest.setEmail("someemail@mail.com");
        testRequest.setPhoneNumber("90099099009");
        testRequest.setPinCode(110001);
        testRequest.setGender(Gender.MALE);
        testRequest.setCreated(LocalDate.now());
        testRequest.setCreatedBy(testRequest.getCreatedBy());
        testRequest.setStatus(RequestStatus.INITIATED);
        return testRequest;
    }

    private User createTestTester() {
...
*/
    ...
    public CreateLabResult getCreateLabResult(TestRequest testRequest) {
        ...
        createLabResult.setComments("Something");
