...
public class ConsultationController {
    ...
    public List<TestRequest> getForConsultations() {
        ...
        return consultationService.getConsultationList();//getting list of consultation requests
    }
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        // For reference check the method getPendingTests() method from TestRequestController class
            ...
            return testRequestQueryService.findByDoctor(user);//to return assigned list of consultation for a doctor
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        try {
            User user = userLoggedInService.getLoggedInUser();
            TestRequest result = testRequestUpdateService.assignForConsultation(id, user);//assigning consultation requests
            return result;
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        try {
            User user =userLoggedInService.getLoggedInUser();
            TestRequest testRequest =  testRequestUpdateService.updateConsultation(id, testResult, user);//for updating consultation comments
            return testRequest;
