...
public class LabRequestController {
    ...
    public List<TestRequest> getForTests()  {
        ...
        return labResultService.getTestList();//getting list of test requests
    }
    ...
    public List<TestRequest> getForTester()  {
        ...
        return testRequestQueryService.findByTester(user);//to return assigned list of tests for a tester
    }
    ...
    public TestRequest assignForLabTest(@PathVariable Long id) {
        ...
        try {
            User user = userLoggedInService.getLoggedInUser();
            TestRequest result = testRequestUpdateService.assignForLabTest(id, user);//assigning test requests
            return result;
    ...
    public TestRequest updateLabTest(@PathVariable Long id,@RequestBody CreateLabResult createLabResult) {
        ...
        User user =userLoggedInService.getLoggedInUser();
        TestRequest testRequest = testRequestUpdateService.updateLabTest(id,createLabResult,user);//for updating test results
        return testRequest;
    }
}